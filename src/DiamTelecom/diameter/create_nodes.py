...
def create_gy_app(max_threads) -> GyApplication:
    return GyApplication(APP_DIAMETER_CREDIT_CONTROL_APPLICATION, is_acct_application=False, is_auth_application=True, max_threads=max_threads, request_handler=handle_request)
