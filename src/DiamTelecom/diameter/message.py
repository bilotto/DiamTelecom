...
#     if isinstance(request_flag, str):
#         if request_flag.upper() == "TRUE":
#             request_flag = 1
#         else:
#             request_flag = 0
#     elif isinstance(request_flag, bool):
...
#     message_object = None
#     print(f"Creating Diameter Message: {cmd_code}, {request_flag}, {cc_request_type}")
